...
ALL_SNAKE_DIRECTIONS = [
    ...
    SnakeDirection.NORTH + SnakeDirection.EAST,
    SnakeDirection.EAST,
    SnakeDirection.SOUTH + SnakeDirection.EAST,
    SnakeDirection.SOUTH,
    SnakeDirection.SOUTH + SnakeDirection.WEST,
    SnakeDirection.WEST,
    SnakeDirection.WEST + SnakeDirection.NORTH,
]
...
ALL_SNAKE_ACTIONS = [
    ...
    SnakeAction.TURN_LEFT1,
    SnakeAction.TURN_LEFT2,
    SnakeAction.TURN_LEFT3,
    SnakeAction.TURN_RIGHT1,
    SnakeAction.TURN_RIGHT2,
    SnakeAction.TURN_RIGHT3,
    SnakeAction.TURN_BACK,
]
...
class Field(object):
    ...
    def update_snake_footprint(self, old_head, old_tail, new_head):
        ...
        if old_tail:
            self[old_tail] = CellType.SNAKE_BODY
